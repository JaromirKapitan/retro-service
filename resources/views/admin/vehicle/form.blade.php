...
{{--                            <div class="text-muted">{{ __('admin.not_required_but_nice_to_have') }}</div>--}}
                        </div>

{{--                        <div class="col-md-4">--}}
{{--                            <x-form.textarea name="modifications" :label="__('admin.modifications_on_vehicle')"--}}
{{--                                             addClass="ckeditor">{{ $model->modifications }}</x-form.textarea>--}}
{{--                        </div>--}}
{{--                        <div class="col-md-4">--}}
