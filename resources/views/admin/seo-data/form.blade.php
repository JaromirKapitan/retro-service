<div class="card h-100 seo-form">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            <label for="seo.title" class="form-label">{{ __('admin.title') }}</label>
        ...
        <div class="mb-3">
            <label for="seo.slug" class="form-label">{{ __('admin.slug') }}</label>
        ...
        <div class="mb-3">
            <label for="seo.description" class="form-label">{{ __('admin.description') }}</label>
        ...
        <div class="mb-3">
            <label for="seo.keywords" class="form-label">{{ __('admin.keywords') }}</label>
