<nav class="navbar navbar-expand-md sticky-top bg-light-subtle" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ route('admin.users.index') }}">{{ __('admin.users') }}</a>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbarSubLeft" aria-labelledby="offcanvasNavbarSubLeftLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a @class(['nav-link', 'active'=>request()->routeIs('admin.users.index')]) href="{{ route('admin.users.index') }}">
                            <i class="fa fa-list"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a @class(['nav-link', 'active'=>request()->routeIs('admin.users.create')]) href="{{ route('admin.users.create') }}">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbarSubRight" aria-labelledby="offcanvasNavbarSubRightLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a @class(['nav-link', 'active'=>request()->routeIs('admin.users.show')]) href="{{ route('admin.users.show', $model) }}">
                                <i class="fa fa-info"></i>
                            </a>
                        </li>
{{--                        <li class="nav-item">--}}
{{--                            <a @class(['nav-link', 'active'=>request()->routeIs('admin.users.images')]) href="{{ route('admin.users.images', $model) }}">--}}
{{--                                <i class="fa fa-image"></i>--}}
{{--                            </a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a @class(['nav-link', 'active'=>request()->routeIs('admin.users.files')]) href="{{ route('admin.users.files', $model) }}">--}}
{{--                                <i class="fa fa-file"></i>--}}
{{--                            </a>--}}
{{--                        </li>--}}
                        <li class="nav-item">
                            <a @class(['nav-link', 'active'=>request()->routeIs('admin.users.edit')]) href="{{ route('admin.users.edit', $model) }}">
                        ...
                        <li class="nav-item">
                            ...
                            <form action="{{ route('admin.users.destroy', $model) }}" method="POST" class="d-none">
                                @csrf
                                @method('DELETE')
                            </form>
                        </li>
