<nav class="navbar navbar-expand-md sticky-top bg-light-subtle" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ route('admin.tasks.index') }}">{{ __('admin.tasks') }}</a>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbarSubLeft" aria-labelledby="offcanvasNavbarSubLeftLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a @class(['nav-link', 'active'=>request()->routeIs('admin.tasks.index')]) href="{{ route('admin.tasks.index') }}">
                            <i class="fa fa-list"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a @class(['nav-link', 'active'=>request()->routeIs('admin.tasks.create')]) href="{{ route('admin.tasks.create') }}">
        ...
        @if(!empty($model) && $model->id)
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbarSubRight" aria-labelledby="offcanvasNavbarSubRightLabel">
                ...
                <div class="offcanvas-body">
                    <x-entity.detail-buttons entity="tasks" :model="$model" :multilang="\App\Enums\LangEnum::isMultilang()"/>
                </div>
            </div>
        @endif
    </div>
