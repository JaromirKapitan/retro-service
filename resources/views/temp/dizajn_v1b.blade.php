...
<html lang="sk">
    <head>
        ...
        <style>
            ...
            .sidebar {
                width: 240px; height: 100vh; transition: all 0.3s ease;
            }
            .sidebar .nav-link { color: #ccc; white-space: nowrap; }
        ...
        <div class="offcanvas offcanvas-start bg-dark text-white" tabindex="-1" id="offcanvasSidebar">
            ...
            <div class="offcanvas-body">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a class="nav-link text-white" data-bs-toggle="collapse" href="#mobileSubWeb"> <i class="bi bi-globe me-1"></i> Web stránky</a>
                        <div class="collapse" id="mobileSubWeb">
                            <ul class="nav flex-column ms-3">
                                <li><a href="#" class="nav-link text-white">Usporiadanie stránok</a></li>
                                <li><a href="#" class="nav-link text-white">Tvorba menu</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item mb-2">
                        <a class="nav-link text-white" data-bs-toggle="collapse" href="#mobileSubArticles" aria-expanded="true">
                            <i class="bi bi-journal-text me-1"></i> Articles
                        </a>
                        <div class="collapse show" id="mobileSubArticles">
                            <ul class="nav flex-column ms-3">
                                <li><a href="#" class="nav-link text-white active">Výpis článkov</a></li>
                                <li><a href="#" class="nav-link text-white">Pridanie článku</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
